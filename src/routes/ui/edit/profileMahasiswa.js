...
import { getMahasiswaProfile , postPendaftaranUkm , updatePendaftaranAnggota, clearFormPendaftaran} from "Redux/actions";
...
handleTerima(){
    this.setState({is_alumni:1})
    this.props.updatePendaftaranAnggota({pendaftaran_id: this.props.location.state , is_alumni:1} , this.props.history)
}
handleTolak(){
  ...
  render() {
    ...
    return (
      ...
      <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          ...
          <ModalBody>
            Apakah <b>{this.props.nama}</b> sudah menjadi alumni ukm Anda? 
            <br/>
            <br/>
            <br/>
          ...
          <ModalFooter>
            <Button color="primary" onClick={this.handleTerima}>Ya</Button>
