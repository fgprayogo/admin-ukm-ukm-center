...
class PendaftaranDitutup extends Component {
    constructor(props) {
      super(props);
  ...
  const mapStateToProps = ({ ukmReducer }) => {
    const { id , nama_ukm , profile_ukm , ditutup} = ukmReducer;
    return {  id , nama_ukm , profile_ukm , ditutup};
  };
  ...
  )(injectIntl(mouseTrap(PendaftaranDitutup)));
