                        ...
                        <Card className="mb-5 invoice-contents">
                            <CardBody className="d-flex flex-column justify-content-between">
                                <div className="d-flex flex-column">
                                    <div className="d-flex flex-row justify-content-between pt-2 pb-2">
                                        ...
                                        <div className="d-flex w-30 text-right align-self-center">
                                            <p className="text-small text-semi-muted mb-0">ColoredStrategies Inc 35 Little Russell St. Bloomsburg London,UK<br />784 451 12 47</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="d-flex flex-row justify-content-between mb-5">
                                        <div className="d-flex flex-column w-70 mr-2 p-4 text-semi-muted bg-semi-muted">
                                            ...
                                            <p className="mb-0">100-148 Warwick Trfy, Kansas City, USA</p>
                                        </div>
                                    ...
                                    <Table borderless>
                                        <thead>
                                            <tr>
                                                <th className="text-muted text-extra-small mb-2">ITEM NAME</th>
                                                <th className="text-muted text-extra-small mb-2">COUNT</th>
                                                <th className="text-right text-muted text-extra-small mb-2">PRICE</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                ...
                                <div className="d-flex flex-column">
                                    ...
                                    <div className="border-bottom pt-3 mb-5"></div>
                                    <p className="text-muted text-small text-center">Invoice was created on a computer and is valid without the signature and seal. </p>
                                </div>
