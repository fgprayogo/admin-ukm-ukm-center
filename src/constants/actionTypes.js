...
export const CLEAR_FORM_FAKULTAS = 'CLEAR_FORM_FAKULTAS'
export const CLEAR_FORM_PRODI = 'CLEAR_FORM_PRODI'


/* UKM */
export const GET_UKM = 'GET_UKM';
// export const GET_PROFILE = 'GET_PROFILE';
export const GET_UKM_PROFILE = 'GET_UKM_PROFILE'
export const POST_PENDAFTAR_UKM = 'POST_PENDAFTAR_UKM'

/* PENDAFTARAN */

export const GET_PENDAFTARAN = 'GET_PENDAFTARAN';
export const GET_MAHASISWA_PROFILE = 'GET_MAHASISWA_PROFILE'
